  ...
  render() {
    ...
    return (
      <div className={classes.Auth}>
        ...
        <Button btnType="Danger" clicked={this.toggleAuthType}>
          {this.state.isSignUp ? "Swith To Sign In" : "Switch To Sign Up"}
        </Button>
      </div>
    );
  }
...
const mapDispatchToProps = (dispatch) => {
  return {
    onInitAuth: (email, password, signUp) =>
      dispatch(actions.authInit(email, password, signUp)),
